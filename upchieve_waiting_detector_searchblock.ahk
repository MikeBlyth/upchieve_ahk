...
StartDetector() {
    ...
    while (IsActive) {
        ...
        if (SessionState == WAITING_FOR_STUDENT) {
            ToolTip stateText, tooltipX, tooltipY, 2
        ...
        if (SessionState == WAITING_FOR_STUDENT) {
            ...
            WriteLog("Waiting student detected")
            ...
            WriteLog("OCR finished: " . rawStudentName . " (" . extractionTime . "ms)")
            ...
            if (LiveMode) {
                ...
                clickTimeFromOCR := A_TickCount - (detectionStartTime + extractionTime)
                WriteLog("Clicked on " . correctedName . " (" . clickTime . "ms from detection, " . clickTimeFromOCR . "ms from OCR)")
